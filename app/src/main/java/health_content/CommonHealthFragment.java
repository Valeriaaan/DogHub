...
public class CommonHealthFragment extends Fragment {

    public CommonHealthFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_common_health_issues, container, false);
